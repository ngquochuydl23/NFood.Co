...
const MenuItems = [
  {
    icon: IcDashboard,
    activeIcon: IcDashboardActive,
    name: "Dashboard",
    path: "dashboard",
  },
  {
    icon: IcInsights,
    activeIcon: IcInsightsActive,
    name: "Insights",
    path: "insights",
  },
  {
  ...
  {
    icon: IcMenuManagement,
    activeIcon: IcMenuManagementActive,
    name: "Menus",
    path: "menus",
  },
  {
...
const Sidebar = ({}) => {
  ...
  const SideHeader = () => {
    return (
      <SidebarHeader>
        <div className="side-bar-header">'sidebarTitle'</div>
      </SidebarHeader>
    );
  };

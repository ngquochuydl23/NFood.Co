...
const DetailFoodDialog = ({ isOpen, onClose, detailFood, onAddedToCard }) => {
  ...
  return (
    <DialogContainer onClose={handleClose} isOpen={isOpen} isPadding={false}>
      <div className="detail-food-dialog">
        <img className="food-image" alt="foodimage" src={foodImage} />
